...
- Le `MCD` est généralement créé à l'aide de **diagrammes entité-association (ER)** qui montrent les **entités** (objets ou concepts du monde réel), leurs **attributs** et les **associations** entre elles. 
